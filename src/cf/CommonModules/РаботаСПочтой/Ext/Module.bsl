...
Функция ОтправитьПисьмо(Письмо) Экспорт
	...
	// { Каратаев Олег - 07.04.2025
	ПисьмоУспешноОтправлено = ОтправитьПисьмоПоИнтернетПочте(Профиль, Сообщение);
	//--1С--
	...
	Запись.Отправлено = ПисьмоУспешноОтправлено;
	НЗ.Записать();
	Возврат Истина;
КонецФункции
...
Функция ОтправитьПисьмоПоИнтернетПочте(Профиль, Сообщение)
	...
	Возврат Истина; // Отправка успешна	
